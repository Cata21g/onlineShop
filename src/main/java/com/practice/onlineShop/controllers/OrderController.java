...
public class OrderController {
    ...
    @PostMapping
    public void addOrder(@RequestBody OrderVO orderVO) throws InvalidProductsException, InvalidProductIdException, InvalidCustomerIdExceptions, NotEnoughStockException {
        orderService.addOrder(orderVO);

    }

    @PatchMapping("/{orderId}/{customerId}")
    public void delivery(@PathVariable Integer orderId, @PathVariable Long customerId) throws InvalidOrderIdException, OrderCanceledException {
